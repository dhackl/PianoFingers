...
namespace CSharpSynth.Wave
{
    public class WaveFileWriter
    {
        ...
        public void Close()
        {
            ...
            //UnitySynth
            // BW.Dispose();
			using (BinaryWriter bw2 = new BinaryWriter (System.IO.File.OpenRead (Path.GetDirectoryName (fileN)))) 
			{
				...
				using (BinaryReader br = new BinaryReader (System.IO.File.OpenRead (Path.GetDirectoryName (fileN) + "RawWaveData_1tmp"))) 
				{
